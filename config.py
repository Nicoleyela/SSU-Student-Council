...
config_data = {
    "app_admin_name": 'SSU-BC Student Council Portal',
    "app_admin_template_mode": "bootstrap3",
    "access_deny_message": "Access Denied!, you need to Login First!",
    "basedir":os.getcwd(),
    "image_file_path": os.path.join(basedir,'static\\assets\\images'),
    "database_location": 'sqlite:///' + os.path.join(os.getcwd(), 'ssu.db'),
